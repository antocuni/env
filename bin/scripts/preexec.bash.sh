...
function preexec_xterm_title_install () {
    ...
    function precmd () {
        ...
        then
            ...
            then
                preexec_screen_title "${PROMPTCHAR}"
            else
                preexec_screen_title "${USER}@${SCREEN_HOST}${PROMPTCHAR}"
            fi
        fi
    }
    ...
    function preexec () {
        ...
        then
            ...
            if [[ "$SCREEN_RUN_HOST" == "$SCREEN_HOST" ]]
            then
                preexec_screen_title "${PROMPTCHAR}$cmdtitle"
            else
                preexec_screen_title "${USER}@${SCREEN_HOST}${PROMPTCHAR}$cmdtitle"
            fi
        fi
    }
